...
//  Copyright (c) 2015 Wait & Buy. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Initialize Parse.
        Parse.setApplicationId("8gjlvPcqeoOcMy6AHEEeAzwinCgFVfv7XWdzmUl6",
            clientKey: "bHZgRZIe0Ry7lgA2QNriEhH8HCsUL2kpIMfx0C52")
